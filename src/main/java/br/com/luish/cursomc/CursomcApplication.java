...
import br.com.luish.cursomc.domain.PagamentoComCartao;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PEDENTE, ped2, dateFormat.parse("20/10/2017 00:00"), null);
